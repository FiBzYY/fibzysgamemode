...
-- User Settings
local setting_anticheats      = UTIL:CreateSetting("bhop_anticheats", 0)
local setting_gunsounds       = UTIL:CreateSetting("bhop_gunsounds", 1, true, false, "Toggle Gun Sounds", 0, 1)
local setting_hints           = UTIL:CreateSetting("bhop_hints", 5)
local customFOV               = UTIL:CreateSetting("bhop_set_fov", 90, true, true, "Set custom FOV", 1, 180)
local sounds_enabled          = UTIL:CreateSetting("bhop_wrsfx", 1, true, true, "WR sounds enabled state", 0, 1)
local sounds_volume           = UTIL:CreateSetting("bhop_wrsfx_volume", 0.4, true, false, "WR sounds volume", 0, 1)
local sounds_enabledbad       = UTIL:CreateSetting("bhop_wrsfx_bad", 1, true, false, "Bad improvement sounds", 0, 1)
local chat_sounds             = UTIL:CreateSetting("bhop_chatsounds", 0, true, false, "Play chat sounds", 0, 1)
local zone_sounds             = UTIL:CreateSetting("bhop_zonesounds", 1, true, false, "Play sound on zone left", 0, 1)
local bhop_showplayers        = UTIL:CreateSetting("bhop_showplayerslabel", 1, true, false, "Show or hide player names when looking at them")
local bhop_wepspammer         = UTIL:CreateSetting("bhop_autoshoot", 1, true, false, "Enable or disable weapon auto shoot")
local bhop_joindetails        = UTIL:CreateSetting("bhop_joindetails", 1, true, false, "Show or disable join details")

-- Core CVars
UTIL:CreateSetting("bhop_simpletextures", 0, true, false, "Toggle simple solid textures", 0, 1)
UTIL:CreateSetting("bhop_sourcesensitivity", 0, true, false, "Toggle sensitivity adjustment")
UTIL:CreateSetting("bhop_absolutemousesens", 0, true, false, "Toggle absolute mouse sensitivity adjustment")
UTIL:CreateSetting("bhop_showchatbox", 1, true, false, "Toggle chatbox visibility: 1 for show, 0 for hide", 0, 1)
UTIL:CreateSetting("bhop_nogun", 0, true, false, "Enable or disable no-gun mode")
UTIL:CreateSetting("bhop_nosway", 1, true, false, "Enable or disable gun sway mode")
UTIL:CreateSetting("bhop_showplayers", 1, true, false, "Shows bhop players", 0, 1)
UTIL:CreateSetting("bhop_viewtransfrom", 0, true, false, "Shows transfrom view type", 0, 1)
UTIL:CreateSetting("bhop_thirdperson", 0, true, false, "Shows third person view type", 0, 1)
UTIL:CreateSetting("bhop_viewpunch", 1, true, false, "Enable or disable view punch effect")
UTIL:CreateSetting("bhop_weaponpickup", 1, true, false, "Enable or disable weapon pickup for yourself.")
UTIL:CreateSetting("bhop_viewinterp", 0, true, false, "Enable or disable view interpolation.")
UTIL:CreateSetting("bhop_water_toggle", 0, true, false, "Enable or disable water reflections.")
