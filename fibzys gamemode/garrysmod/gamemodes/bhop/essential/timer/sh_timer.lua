...
TIMER.Ranks = {
    ...
    { "Apprentice", Color(192, 192, 192), 300 },
    { "Brawler", Color(210, 105, 30), 600 },
    { "Trainee", Color(123, 104, 238), 1000 },
    { "Scout", Color(34, 139, 34), 1500 },
    { "Journeyman", Color(70, 130, 180), 2500 },
    { "Adventurer", Color(255, 140, 0), 4000 },
    { "Explorer", Color(154, 255, 154), 6000 },
    { "Skilled", Color(255, 215, 0), 8000 },
    { "Challenger", Color(0, 191, 255), 10000 },
    { "Veteran", Color(255, 99, 71), 13000 },
    { "Mastermind", Color(255, 255, 0), 17000 },
    { "Tactician", Color(255, 160, 122), 21000 },
    { "Strategist", Color(0, 250, 154), 25000 },
    { "Virtuoso", Color(138, 43, 226), 30000 },
    { "Architect", Color(173, 255, 47), 35000 },
    { "Conqueror", Color(255, 20, 147), 40000 },
    { "Overlord", Color(0, 0, 128), 45000 },
    { "Baron", Color(205, 133, 63), 50000 },
    { "Maverick", Color(255, 182, 193), 60000 },
    { "Visionary", Color(255, 105, 180), 70000 },
    { "Immortal", Color(255, 69, 0), 80000 },
    { "Specter", Color(128, 0, 128), 90000 },
    { "Celestial", Color(0, 255, 127), 95000 },
    { "Omnipotent", Color(75, 0, 130), 100000 }
}
